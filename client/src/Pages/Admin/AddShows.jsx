    ...
    <>
      ...
      <div className='overflow-x-auto pb-4'>
            <div className='group flex flex-wrap gap-4 w-max mt-4'>
                {nowPlayingMovies.map((movie)=>(
                    <div onClick={()=>setSelectedMovie(movie.id)} key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1
                    transition duration-300`}>
                        <div className='relative rounded-lg overflow-hidden'>
                            ...
                            <div className='text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                                ...
                                <p className='text-gary-300'>{kConverter(movie.vote_count)} Votes</p>
                            </div>
                        </div>
      ...
      <div className='mt-8'>
       ...
       <div className='mt-6'>
                ...
                <div className='inline-flex gap-2 border border-gray-600 p-1 pl-2 rounded-lg'>
